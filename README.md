...
The presence of a route or screen does not establish a verified end-to-end workflow. Personal responsibilities within the original project have not yet been confirmed; no sole-authorship claim is made.
...
## 中文简介
家政服务课业，采用 Spring Boot / MyBatis 后端及 Vue / Quasar 前端，包含用户、资料和订单相关模块。当前缺少原始数据库建表文件，尚未完成全流程运行验证。
